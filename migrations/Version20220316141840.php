 ...
 */
final class Version20220316141840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande CHANGE prix prix NUMERIC(7, 2) DEFAULT NULL');
        $this->addSql('ALTER TABLE role CHANGE label label VARCHAR(20) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande CHANGE prix prix NUMERIC(7, 2) NOT NULL');
        ...
        $this->addSql('ALTER TABLE role CHANGE label label VARCHAR(255) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`');
